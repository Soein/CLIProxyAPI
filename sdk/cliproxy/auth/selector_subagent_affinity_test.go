...
func TestSessionAffinitySubagentFailureIsolation(t *testing.T) {
	...
	parentCacheKey := sessionAffinityCacheKey("antigravity", "claude:sess-fail-400", "gemini-3.7-flash-high")
	...
	subagentCacheKey := sessionAffinityCacheKey("antigravity", "claude:sess-fail-400:agent:sub-fail-001", "gemini-3.7-flash-high")
...
func TestSessionAffinitySubagentAliasIsolation(t *testing.T) {
	...
	parentCacheKey := sessionAffinityCacheKey("antigravity", "claude:sess-alias-500", "gemini-3.7-flash-high")
