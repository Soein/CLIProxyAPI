...
func (h *Handler) PatchAuthFileFields(c *gin.Context) {
	...
	var req struct {
		...
		// Primary field: controls whether weekly and hourly automation exclude this auth.
		CodexAutomationExcluded *bool `json:"codex_automation_excluded"`
		// Deprecated: retained for backward compatibility. The primary field takes precedence.
	...
	// The new field takes precedence when both fields are provided.
